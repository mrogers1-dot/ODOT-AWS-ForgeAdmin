...
- **High complexity:** Orchestration (multi-agent coordination, state machines, approval gates) and Execution (on-prem bridge, multiple adapters, rollback logic)
...
We apply hexagonal architecture (ports and adapters) to the Orchestration and Execution contexts:
