...
- [ ] 16.1 Enhance feedback aggregator with calibration computation
...
- [ ] 16.2 Implement calibration alert event publishing
...
- [ ] 16.3 Add Communication context subscription for calibration alerts
...
- [ ] 16.4 Implement Dashboard API endpoints for calibration
...
- [ ] 16.5 Add calibration API to Dashboard Terraform module
...
- [ ] 16.6 Implement Reliability Scorecard view (all roles)
...
- [ ] 16.7 Implement Calibration Tuning view (team_lead)
...
- [ ] 16.8 Implement "Create Steering Doc" quick action
...
- [ ] 16.9 Add Zustand store slice and WebSocket integration
